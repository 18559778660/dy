        ...
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                if (container) {
                    ...
                    if (typeof window.initTerminalBrandAnalysis === 'function') {
                        setTimeout(() => window.initTerminalBrandAnalysis(), 330);
                    }

                    if (typeof window.initTerminalClientVersionAnalysis === 'function') {
                        setTimeout(() => window.initTerminalClientVersionAnalysis(), 340);
                    }

                    if (typeof window.initTerminalBasicVersionAnalysis === 'function') {
                        setTimeout(() => window.initTerminalBasicVersionAnalysis(), 350);
                    }
