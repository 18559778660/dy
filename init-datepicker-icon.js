...
(function () {
    ...
    function initDatepickerIconInteraction() {
        const datepickerContainer = document.querySelector('.semi-dy-open-datepicker');
        if (!datepickerContainer) return;

        const iconContainer = datepickerContainer.querySelector('.datePicker-tigger-content-LsTspS');
